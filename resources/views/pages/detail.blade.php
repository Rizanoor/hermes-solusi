              ...
              <div class="col-lg-2" data-aos="zoom-in">
                @auth
                  <form action="{{ route('detail-add', $product->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <button type="submit"
                            class="btn btn-success px4 text-white btn-block mb-3">
                      Add to cart
                    </button>
                  </form>
                @else
                  <a href="{{ route('login') }}" class="btn btn-success px4 text-white btn-block mb-3">
                    Sign in to add
                  </a>
                @endauth
              </div>
                ...
                <ul class="list-unstyled">
                  <li class="media">
                    ...
                    <div class="media-body">
                      <h5 class="mt-2 mb-1">Rizki nazar</h5>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis, nam sequi tempore est quis voluptatibus.
                    </div>
                  </li>
                  <li class="media">
